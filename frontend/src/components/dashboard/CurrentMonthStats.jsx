...
export default function CurrentMonthStats({
  ...
  <div
    ...
    } rounded-xl border shadow-lg overflow-hidden mb-6 md:mb-8`}
  >
    {/* Header */}
    <div
      className={`${
      ...
      } px-4 sm:px-6 py-3 sm:py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0`}
    >
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-gray-700">
      ...
      <div className="p-4 sm:p-6">
        <div className="flex items-start justify-between mb-3">
          ...
          >
            <ArrowUpRight className="w-5 h-5 sm:w-6 sm:h-6 text-green-500" />
          </div>
          <div className="text-right">
            ...
            <p className={`text-xl sm:text-2xl font-bold mt-1 text-cyan-500`}>
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
            <div
              className="h-full bg-linear-to-r from-red-400 to-red-600 rounded-full transition-all duration-500"
              style={{
                width:
                  currentMonthIncome > 0
      ...
      <div className="p-4 sm:p-6">
        <div className="flex items-start justify-between mb-3">
          ...
          >
            {isPositive ? (
              <TrendingUp
                className={`w-5 h-5 sm:w-6 sm:h-6 ${isPositive ? "text-blue-500" : "text-orange-500"}`}
              />
            ) : (
    ...
    <div
      ...
      } px-4 sm:px-6 py-2.5 sm:py-3 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0 text-xs sm:text-sm`}
    >
